...
const Select = forwardRef(({
  ...
  const baseClasses = 'w-full px-3 py-2 pr-10 rounded-lg border-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-1 bg-white dark:bg-neutral-800/50 text-neutral-900 dark:text-neutral-100 appearance-none cursor-pointer shadow-sm';
