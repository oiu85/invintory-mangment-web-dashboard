...
```ts
import { useCreateNewTask, useListAvailableDrivers, useUpdateTaskStatus, useListWarehouseRooms } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateNewTask();
...
const { data, isPending, isSuccess, isError, error } = useListWarehouseRooms();
...
```js
import { createNewTask, listAvailableDrivers, updateTaskStatus, listWarehouseRooms } from '@dataconnect/generated';
